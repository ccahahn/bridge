...
interface Scenario {
  ...
  balance: number; buffer: number; overdraftLimit: number; monthlyRevenue: number; monthsOnPlatform: number;
...
function buildScenarios(): Record<string, Scenario> {
  ...
  for (const sc of db.scenarios) {
    ...
    result[sc.id] = {
      ...
      monthsOnPlatform: biz.months_on_platform,
  ...
  return (
    <div style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', 'Helvetica Neue', sans-serif", background: "#f6f6f8", minHeight: "100vh", display: "flex", color: "#1a1a2e" }}>
      ...
      <div style={{ width: 200, background: "#fff", borderRight: "1px solid #e8e8ec", display: "flex", flexDirection: "column", padding: "24px 0", flexShrink: 0 }}>
        <div style={{ padding: "0 24px 20px", fontSize: 26, fontWeight: 700, letterSpacing: "-0.5px" }}>BRIDGE</div>
          ...
          {showRecommendation && !approved && scenario.recommendation && (
            <div style={{
              ...
              <div style={{ padding: "24px 28px" }}>
                ...
                <div style={{ fontSize: 11, color: "#b0b0ba", marginBottom: 20 }}>This recommendation was generated by the credit assessment system based on your payment history. The final decision is yours.</div>
